...
class ZillowServices:
    ...
    #fetches house address from the CSV files
    def get_home_addresses_trulia(self, county):
        ...
        try:
            ...
            print("Error in Zillow Services while reading county csv file")

        return home_addresses

    # fetch zillow data from file
    def get_zillow_sales_data(self, county_file):
        ...
        try:
            ...
            print("Error in reading Zillow Sales data from csv")
        return sales_data

    # Writes CSV data in file
